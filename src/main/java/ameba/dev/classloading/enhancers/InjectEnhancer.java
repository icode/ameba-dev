...
//                    if (Modifier.isStatic(f.where().getModifiers())) return;
//                    String fName = f.getFieldName();
//                    if (changeFields.contains(fName)) {
//                        if (f.isReader()) {
//                            f.replace("$_ = $0." + fName + ".get();");
//                        } else if (f.isWriter()) {
//                            f.replace("$0." + fName + "=new ameba.core.inject.DelegateProvider($1);");
//                        }
//                    }
//                }
//            });
